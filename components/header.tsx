...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white backdrop-blur-md border-b">
      <div className="container mx-auto px-4 py-4">
        <nav className="flex items-center justify-between relative">
          ...
          <Link href="/" className="hidden md:flex items-center space-x-2">
            <Image src="/logo.svg" alt="Protap & Partners Logo" width={50} height={50} priority />
          </Link>
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 md:hidden">
            <Link href="/" className="flex items-center justify-center">
              <Image src="/logo.svg" alt="Protap & Partners Logo" width={40} height={40} priority />
            </Link>
          </div>
        </nav>
      </div>
